...
L.Control.BootstrapModal = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.controlDiv           = L.DomUtil.create('div', 'leaflet-control-bootstrapmodal leaflet-bar enabled');
	...
	enable: function(){
		L.DomUtil.addClass(this.controlDiv, 'enabled');
		L.DomUtil.removeClass(this.controlDiv, 'disabled');
		this.controlDiv.setAttribute('aria-hidden', 'false');
		L.DomUtil.removeClass(this.controlDiv, 'leaflet-control-bootstrapmodal-disabled');
		return this;
	},

	disable: function(){
		L.DomUtil.addClass(this.controlDiv, 'disabled');
		L.DomUtil.addClass(this.controlDiv, 'leaflet-control-bootstrapmodal-disabled');
		
		L.DomUtil.removeClass(this.controlDiv, 'enabled');
		this.controlDiv.setAttribute('aria-hidden', 'true');
		return this;
	},	

    handleClick: function () {
		if ( this.controlDiv.classList.contains('enabled') ){
